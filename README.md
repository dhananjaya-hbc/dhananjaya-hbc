...
```yaml
 ...
 - Developer building modern and innovative Solution
 - Working on AI, Machine Learning & Software Engineering
 - Learning Cloud Computing, DevOps & System Design
 - Passionate about architecture and creative design
...
<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=python,anaconda,html,css,js,ts,flutter,dart,react,vite,nextjs,astro,tailwind,fastapi,nodejs,express,mysql,mongodb,postgres,firebase,prisma,git,github,docker,kubernetes,linux,gcp,aws,vercel,vscode,figma,c&perline=13" alt="Dhananjaya's Tech Stack" />
</a>
